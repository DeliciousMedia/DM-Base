...
- Prevents enumeration of usernames via ?author=n query strings, helpful for tickybox PCI audits (toggled with `DM_PREVENT_USER_ENUM`; default true).
- Enables the use of real GUIDS (toggled with `DM_USE_REAL_GUIDS`; default false).
